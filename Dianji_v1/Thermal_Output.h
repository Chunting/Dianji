...
IloInt lineNum;
IloInt busNum;
const double outputprice=11;
const double rp=0;
const double nrp=0;
const double r=0.3;
const double _INF=1E-7;//add by hx
const char* OUTFILEDATA= "./Output/check.dat"  ;  //#define声明以及初始化符号常量；此外还可用关键字const unsigned float OUTFILEDATA="check.dat"声明
const char* OUTFILERESULT="./Output/result.dat";
const char* lp= "./Output/hydrothermal.lp" ;    
const char* SYSTEMDATA= "./Output/SystemData.dat" ;  //cycle J horizon flk tlk
const char* APPDATA ="./Output/AppData.dat";     //I,K,LAMDA,PR DISK
const char* THUNITDATA= "./Output/thunitdata.dat";
const char* WINDDATA="./Output/windpower.dat";
const char* NETDATA= "./Output/netdata.dat";
const char* GAMADATA ="./Output/gamadata.dat";

const char* Result_Output="./Output/Result_Output.dat";
const char* Resutl_ThUnit="./Output/Result_ThUnit.dat";
const char* Result_Line="./Output/Result_Line.dat";
...
int readSystemData(const char* systemdata, IloEnv env, IloInt& cycle, IloInt& thUnitNum, IloInt& windUnitNum, IloInt& demandNum, IloInt& outputNum, IloInt& lineNum, IloInt& busNum, IloNum& horizen );
/************************************************************************/
...
/************************************************************************/	
int readGama(const char* gamgadata,IloEnv env,Matrix2& gama)
{
	int i,j;
