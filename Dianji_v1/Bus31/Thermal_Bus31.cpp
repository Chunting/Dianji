...
for (i=0;i<demandNum;i++)
	...
	//	cplex.setParam(cplex.TiLim,100);
		...
		if(!outf)
 		...
 		outf<<endl<<"*************** Result output by Ceplex ********************"<<endl;
        ...
        outf<<endl<<"*************************main fuelCost*******************"<<endl;
		outf<<endl<<"allFuelCost="<<allFuelCost<<endl;
	
        outf<<endl<<"******************current[l][t]**********************"<<endl;
